...
// RecordNew method.
func (p *cmsPlugin) hookNewRecordPre(payload string) error {
...
// RecordEdit method.
func (p *cmsPlugin) hookEditRecordPre(payload string) error {
...
// name.
func (p *cmsPlugin) proposalNameIsValid(name string) bool {
...
// correct.
func (p *cmsPlugin) proposalFilesVerify(files []backend.File) error {
