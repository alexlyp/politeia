...
func (p *politeiawww) processNewDCC(nd cms.NewDCC, u *user.User) (*cms.NewDCCReply, error) {
	...
	/*
		ir, err := convertRecordToDatabaseDCC(r)
		if err != nil {
			return nil, err
		}
	*/
...
func (p *politeiawww) processGetDCC(gd cms.GetDCC) (*cms.GetDCCReply, error) {
	log.Tracef("processGetDCC: %v", gd.Token)
